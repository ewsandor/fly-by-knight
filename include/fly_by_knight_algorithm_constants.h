...
#define FBK_SCORE_PAWN_SEVENTH_ROW (( 5*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_PAWN_SIXTH_ROW   (( 4*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_PAWN_FIFTH_ROW   (( 3*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_PAWN_FOURTH_ROW  (( 2*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_PAWN_THIRD_ROW   (( 1*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_PAWN_SECOND_ROW  (( 0*FBK_SCORE_PAWN) / 20)

#define FBK_SCORE_KNIGHT_EIGHTH_ROW  (( 0*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_SEVENTH_ROW (( 3*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_SIXTH_ROW   ((10*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_FIFTH_ROW   (( 7*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_FOURTH_ROW  (( 5*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_THIRD_ROW   (( 3*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_SECOND_ROW  (( 0*FBK_SCORE_PAWN) / 20)
#define FBK_SCORE_KNIGHT_FIRST_ROW   (( 0*FBK_SCORE_PAWN) / 20)
